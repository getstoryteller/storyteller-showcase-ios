...
final class StorytellerClipsGridTableViewCell: UITableViewCell, StorytellerListViewDelegate {
    ...
    private lazy var storytellerGridViewContainer: StorytellerClipsGridView = {
    ...
    func configure(with item: StorytellerItem) {
        ...
        storytellerGridViewContainer.collectionId = item.collection
