...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StorytellerSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Note - below iOS 11 - if is the first view in parent’s hierarchy -> view needs to have at least 114pt height will not render correctly
SWIFT_CLASS("_TtC14StorytellerSDK18StorytellerRowView")
@interface StorytellerRowView : UIView
/// /////NibLoadableView
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder SWIFT_UNAVAILABLE;
@property (nonatomic, copy) IBInspectable NSString * _Nonnull uiStyle;
...
/// Start loading fresh data for all channels from the API
- (void)reloadData;
@end
