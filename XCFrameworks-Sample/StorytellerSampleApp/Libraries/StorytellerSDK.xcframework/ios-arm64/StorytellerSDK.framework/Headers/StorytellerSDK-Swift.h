...
#ifndef STORYTELLERSDK_SWIFT_H
#define STORYTELLERSDK_SWIFT_H
...
SWIFT_CLASS("_TtC14StorytellerSDK23StorytellerSDKResources")
@interface StorytellerSDKResources : NSObject
